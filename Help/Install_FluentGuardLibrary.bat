...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "FluentGuard Library" /productName "FluentGuard Library" > NUL
...
COPY /Y "FluentGuard Library.msha" HelpContentSetup.msha
