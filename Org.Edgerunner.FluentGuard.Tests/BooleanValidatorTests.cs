...
namespace Org.Edgerunner.FluentGuard.Tests
{
   ...
   public class BooleanValidatorTests
   {
      ...
      /// <param name="validatorBase">The <see cref="BooleanValidator" /> to test with.</param>
      ...
      [Example("foo", true, true)]
      [Example("foo", false, false)]
      public void TestParameterNotEqualToFails(string parameterName, bool parameterValue, bool valueToCompare, BooleanValidator validatorBase, Action act)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Scenario]
      [Example("foo", false)]
      public void TestParameterIsTrueFails(string parameterName, bool parameterValue, BooleanValidator validatorBase, Action act)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Scenario]
      [Example("foo", true)]
      public void TestParameterIsTruePasses(string parameterName, bool parameterValue, BooleanValidator validatorBase)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
