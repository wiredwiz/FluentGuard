...
namespace Org.Edgerunner.FluentGuard.Tests
{
   ...
   public class NullableByteValidatorTests
   {
      ...
      /// <param name="validatorBase">The <see cref="NullableUnsignedNumericValidator{Byte}" /> to test with.</param>     
      [Scenario]
      [NullableByteExample("foo1", 9, 2)]
      [NullableByteExample("foo2", 4, 2)]
      [NullableByteExample("foo3", 1, 0)]
      [NullableByteExample("foo4", 0, null)]
      public void TestParameterGreaterThanPasses(string parameterName, byte? parameterValue, byte? valueToCompare, NullableUnsignedNumericValidator<byte> validatorBase)
      {
      ...
      public void TestParameterIsNotPositiveFails(string parameterName, byte? parameterValue, NullableUnsignedNumericValidator<byte> validatorBase, Action act)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      public void TestParameterIsNotPositivePasses(string parameterName, byte? parameterValue, NullableUnsignedNumericValidator<byte> validatorBase)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [NullableByteExample("foo1", 0)]
      [NullableByteExample("foo2", null)]
      public void TestParameterIsPositiveFails(string parameterName, byte? parameterValue, NullableUnsignedNumericValidator<byte> validatorBase, Action act)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [NullableByteExample("foo1", 1)]
      [NullableByteExample("foo2", 255)]
      public void TestParameterIsPositivePasses(string parameterName, byte? parameterValue, NullableUnsignedNumericValidator<byte> validatorBase)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      public void TestParameterNotNullFails(string parameterName, byte? parameterValue, NullableUnsignedNumericValidator<byte> validatorBase, Action act)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Scenario]
      [NullableByteExample("foo1", null)]
      public void TestParameterIsNullPasses(string parameterName, byte? parameterValue, NullableUnsignedNumericValidator<byte> validatorBase)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
