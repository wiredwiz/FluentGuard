...
namespace Org.Edgerunner.FluentGuard.Tests
{
   ...
   public class FloatValidatorTests
   {
      ...
      /// <param name="validator">The <see cref="NumericValidator{Float}" /> to test with.</param>
      ...
      public void TestParameterConditionAndFailsLower(
         ...
         float lowerBound,
         float upperBound,
         NumericValidator<float> validator,
         Action act)
      {
      ...
      public void TestParameterGreaterThanPasses(string parameterName, float parameterValue, float valueToCompare, NumericValidator<float> validator)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 1.00001)]
      public void TestParameterIsNegativeFails(string parameterName, float parameterValue, NumericValidator<float> validator, Action act)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", -1)]
      [Example("foo", -4)]
      public void TestParameterIsNegativePasses(string parameterName, float parameterValue, NumericValidator<float> validator)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", -1)]
      [Example("foo", -4)]
      public void TestParameterIsNotNegativeFails(string parameterName, float parameterValue, NumericValidator<float> validator, Action act)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsNotNegativePasses(string parameterName, float parameterValue, NumericValidator<float> validator)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsNotPositiveFails(string parameterName, float parameterValue, NumericValidator<float> validator, Action act)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", -1)]
      [Example("foo", -4)]
      public void TestParameterIsNotPositivePasses(string parameterName, float parameterValue, NumericValidator<float> validator)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", -0.001)]
      [Example("foo", -1)]
      public void TestParameterIsPositiveFails(string parameterName, float parameterValue, NumericValidator<float> validator, Action act)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsPositivePasses(string parameterName, float parameterValue, NumericValidator<float> validator)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
