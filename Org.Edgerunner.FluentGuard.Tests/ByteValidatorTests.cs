...
namespace Org.Edgerunner.FluentGuard.Tests
{
   ...
   public class ByteValidatorTests
   {
      ...
      /// <param name="validatorBase">The <see cref="UnsignedNumericValidator{Byte}" /> to test with.</param>     
      [Scenario]
      [Example("foo", 9, 2)]
      [Example("foo", 4, 2)]
      [Example("foo", 1, 0)]
      public void TestParameterGreaterThanPasses(string parameterName, byte parameterValue, byte valueToCompare, UnsignedNumericValidator<byte> validatorBase)
      {
      ...
      public void TestParameterConditionAndFailsLower(
         ...
         byte lowerBound,
         byte upperBound,
         UnsignedNumericValidator<byte> validatorBase,
         Action act)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsNotPositiveFails(string parameterName, byte parameterValue, UnsignedNumericValidator<byte> validatorBase, Action act)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Scenario]
      [Example("foo", 0)]
      public void TestParameterIsNotPositivePasses(string parameterName, byte parameterValue, UnsignedNumericValidator<byte> validatorBase)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Scenario]
      [Example("foo", 0)]
      public void TestParameterIsPositiveFails(string parameterName, byte parameterValue, UnsignedNumericValidator<byte> validatorBase, Action act)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsPositivePasses(string parameterName, byte parameterValue, UnsignedNumericValidator<byte> validatorBase)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
