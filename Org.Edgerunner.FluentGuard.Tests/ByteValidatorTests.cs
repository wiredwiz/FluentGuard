...
namespace Org.Edgerunner.FluentGuard.Tests
{
   ...
   public class ByteValidatorTests
   {
      ...
      /// <param name="validator">The <see cref="UnsignedNumericValidator{Byte}" /> to test with.</param>     
      [Scenario]
      [Example("foo", 9, 2)]
      [Example("foo", 4, 2)]
      [Example("foo", 1, 0)]
      public void TestParameterGreaterThanPasses(string parameterName, byte parameterValue, byte valueToCompare, UnsignedNumericValidator<byte> validator)
      {
      ...
      public void TestParameterConditionAndFailsLower(
         ...
         byte lowerBound,
         byte upperBound,
         UnsignedNumericValidator<byte> validator,
         Action act)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsNotPositiveFails(string parameterName, byte parameterValue, UnsignedNumericValidator<byte> validator, Action act)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Scenario]
      [Example("foo", 0)]
      public void TestParameterIsNotPositivePasses(string parameterName, byte parameterValue, UnsignedNumericValidator<byte> validator)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Scenario]
      [Example("foo", 0)]
      public void TestParameterIsPositiveFails(string parameterName, byte parameterValue, UnsignedNumericValidator<byte> validator, Action act)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsPositivePasses(string parameterName, byte parameterValue, UnsignedNumericValidator<byte> validator)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
