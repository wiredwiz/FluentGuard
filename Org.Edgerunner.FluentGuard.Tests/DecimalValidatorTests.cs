...
// <copyright file="DecimalValidatorTests.cs" company="Edgerunner.org">
...
namespace Org.Edgerunner.FluentGuard.Tests
{
   ...
   public class DecimalValidatorTests : ValidatorTests<decimal>
   {
      /// <summary>
      ...
      public override void TestParameterGreaterThanPasses(string parameterName, decimal parameterValue, decimal valueToCompare, Validator<decimal> validator)
      {
      ...
      [Example("foo", 1)]
      [Example("foo", 1.00001)]
      public override void TestParameterIsFalseFails(string parameterName, decimal parameterValue, Validator<decimal> validator, Action act)
      {
      ...
      [Example("foo", 1)]
      [Example("foo", 1.00001)]
      public override void TestParameterIsNegativeFails(string parameterName, decimal parameterValue, Validator<decimal> validator, Action act)
      {
      ...
      [Example("foo", -1)]
      [Example("foo", -4)]
      public override void TestParameterIsNegativePasses(string parameterName, decimal parameterValue, Validator<decimal> validator)
      {
      ...
      [Example("foo", -1)]
      [Example("foo", -4)]
      public override void TestParameterIsNotNegativeFails(string parameterName, decimal parameterValue, Validator<decimal> validator, Action act)
      {
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public override void TestParameterIsNotNegativePasses(string parameterName, decimal parameterValue, Validator<decimal> validator)
      {
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public override void TestParameterIsNotPositiveFails(string parameterName, decimal parameterValue, Validator<decimal> validator, Action act)
      {
      ...
      [Example("foo", -1)]
      [Example("foo", -4)]
      public override void TestParameterIsNotPositivePasses(string parameterName, decimal parameterValue, Validator<decimal> validator)
      {
      ...
      [Example("foo", -0.001)]
      [Example("foo", -1)]
      public override void TestParameterIsPositiveFails(string parameterName, decimal parameterValue, Validator<decimal> validator, Action act)
      {
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public override void TestParameterIsPositivePasses(string parameterName, decimal parameterValue, Validator<decimal> validator)
      {
      ...
      [Example("foo", 0)]
      [Example("foo", 1)]
      public override void TestParameterIsTrueFails(string parameterName, decimal parameterValue, Validator<decimal> validator, Action act)
      {
         "Given a new validator".x(() => validator = Ensure.That(parameterName, parameterValue));
      ...
      [Example("foo", 0)]
      [Example("foo", 1)]
      public override void TestParameterNotNullPasses(string parameterName, decimal parameterValue, Validator<decimal> validator)
      {
