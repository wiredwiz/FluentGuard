...
namespace Org.Edgerunner.FluentGuard.Tests
{
   ...
   public class DecimalValidatorTests
   {
      ...
      /// <param name="validatorBase">The <see cref="NumericValidator{Decimal}" /> to test with.</param>
      ...
      public void TestParameterConditionAndFailsLower(
         ...
         decimal lowerBound,
         decimal upperBound,
         NumericValidator<decimal> validatorBase,
         Action act)
      {
      ...
      public void TestParameterGreaterThanPasses(string parameterName, decimal parameterValue, decimal valueToCompare, NumericValidator<decimal> validatorBase)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 1.00001)]
      public void TestParameterIsNegativeFails(string parameterName, decimal parameterValue, NumericValidator<decimal> validatorBase, Action act)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", -1)]
      [Example("foo", -4)]
      public void TestParameterIsNegativePasses(string parameterName, decimal parameterValue, NumericValidator<decimal> validatorBase)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", -1)]
      [Example("foo", -4)]
      public void TestParameterIsNotNegativeFails(string parameterName, decimal parameterValue, NumericValidator<decimal> validatorBase, Action act)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsNotNegativePasses(string parameterName, decimal parameterValue, NumericValidator<decimal> validatorBase)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsNotPositiveFails(string parameterName, decimal parameterValue, NumericValidator<decimal> validatorBase, Action act)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", -1)]
      [Example("foo", -4)]
      public void TestParameterIsNotPositivePasses(string parameterName, decimal parameterValue, NumericValidator<decimal> validatorBase)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", -0.001)]
      [Example("foo", -1)]
      public void TestParameterIsPositiveFails(string parameterName, decimal parameterValue, NumericValidator<decimal> validatorBase, Action act)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsPositivePasses(string parameterName, decimal parameterValue, NumericValidator<decimal> validatorBase)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
