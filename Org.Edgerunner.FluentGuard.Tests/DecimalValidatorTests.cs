...
namespace Org.Edgerunner.FluentGuard.Tests
{
   ...
   public class DecimalValidatorTests
   {
      ...
      /// <param name="validator">The <see cref="NumericValidator{Decimal}" /> to test with.</param>
      ...
      public void TestParameterConditionAndFailsLower(
         ...
         decimal lowerBound,
         decimal upperBound,
         NumericValidator<decimal> validator,
         Action act)
      {
      ...
      public void TestParameterGreaterThanPasses(string parameterName, decimal parameterValue, decimal valueToCompare, NumericValidator<decimal> validator)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 1.00001)]
      public void TestParameterIsNegativeFails(string parameterName, decimal parameterValue, NumericValidator<decimal> validator, Action act)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", -1)]
      [Example("foo", -4)]
      public void TestParameterIsNegativePasses(string parameterName, decimal parameterValue, NumericValidator<decimal> validator)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", -1)]
      [Example("foo", -4)]
      public void TestParameterIsNotNegativeFails(string parameterName, decimal parameterValue, NumericValidator<decimal> validator, Action act)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsNotNegativePasses(string parameterName, decimal parameterValue, NumericValidator<decimal> validator)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsNotPositiveFails(string parameterName, decimal parameterValue, NumericValidator<decimal> validator, Action act)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", -1)]
      [Example("foo", -4)]
      public void TestParameterIsNotPositivePasses(string parameterName, decimal parameterValue, NumericValidator<decimal> validator)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", -0.001)]
      [Example("foo", -1)]
      public void TestParameterIsPositiveFails(string parameterName, decimal parameterValue, NumericValidator<decimal> validator, Action act)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsPositivePasses(string parameterName, decimal parameterValue, NumericValidator<decimal> validator)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
