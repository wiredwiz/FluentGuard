...
namespace Org.Edgerunner.FluentGuard.Tests
{
   ...
   public class UnsignedLongValidatorTests
   {
      ...
      /// <param name="validator">The <see cref="UnsignedNumericValidator{ULong}" /> to test with.</param>     
      [Scenario]
      [Example("foo", 9, 2)]
      [Example("foo", 4, 2)]
      [Example("foo", 1, 0)]
      public void TestParameterGreaterThanPasses(string parameterName, ulong parameterValue, ulong valueToCompare, UnsignedNumericValidator<ulong> validator)
      {
      ...
      public void TestParameterConditionAndFailsLower(
         ...
         ulong lowerBound,
         ulong upperBound,
         UnsignedNumericValidator<ulong> validator,
         Action act)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsNotPositiveFails(string parameterName, ulong parameterValue, UnsignedNumericValidator<ulong> validator, Action act)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Scenario]
      [Example("foo", 0)]
      public void TestParameterIsNotPositivePasses(string parameterName, ulong parameterValue, UnsignedNumericValidator<ulong> validator)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Scenario]
      [Example("foo", 0)]
      public void TestParameterIsPositiveFails(string parameterName, ulong parameterValue, UnsignedNumericValidator<ulong> validator, Action act)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsPositivePasses(string parameterName, ulong parameterValue, UnsignedNumericValidator<ulong> validator)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
