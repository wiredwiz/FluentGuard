...
namespace Org.Edgerunner.FluentGuard.Tests
{
   ...
   public class UnsignedLongValidatorTests : ValidatorTests<ulong>
   {
      /// <summary>
      ...
      [Example("foo", 4, 2)]
      [Example("foo", 1, 0)]
      public override void TestParameterGreaterThanPasses(string parameterName, ulong parameterValue, ulong valueToCompare, Validator<ulong> validator)
      {
      ...
      [Example("foo", 0)]
      [Example("foo", 1)]
      public override void TestParameterIsFalseFails(string parameterName, ulong parameterValue, Validator<ulong> validator, Action act)
      {
      ...
      [Example("foo", 0)]
      [Example("foo", 1)]
      public override void TestParameterIsNegativeFails(string parameterName, ulong parameterValue, Validator<ulong> validator, Action act)
      {
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public override void TestParameterIsNotNegativePasses(string parameterName, ulong parameterValue, Validator<ulong> validator)
      {
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public override void TestParameterIsNotPositiveFails(string parameterName, ulong parameterValue, Validator<ulong> validator, Action act)
      {
      ...
      [Scenario]
      [Example("foo", 0)]
      public override void TestParameterIsNotPositivePasses(string parameterName, ulong parameterValue, Validator<ulong> validator)
      {
      ...
      [Scenario]
      [Example("foo", 0)]
      public override void TestParameterIsPositiveFails(string parameterName, ulong parameterValue, Validator<ulong> validator, Action act)
      {
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public override void TestParameterIsPositivePasses(string parameterName, ulong parameterValue, Validator<ulong> validator)
      {
      ...
      [Example("foo", 0)]
      [Example("foo", 1)]
      public override void TestParameterIsTrueFails(string parameterName, ulong parameterValue, Validator<ulong> validator, Action act)
      {
         "Given a new validator".x(() => validator = Ensure.That(parameterName, parameterValue));
      ...
      [Example("foo", 0)]
      [Example("foo", 1)]
      public override void TestParameterNotNullPasses(string parameterName, ulong parameterValue, Validator<ulong> validator)
      {
