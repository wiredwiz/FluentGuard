...
namespace Org.Edgerunner.FluentGuard.Tests.Data
{
   ...
   /// </summary>
   public class NullableSByteExampleAttribute : NullableExampleAttribute
   {
      /// <summary>
      ...
      public NullableSByteExampleAttribute(params object[] data)
         : base(data)
      {
         ...
         for (int i = 0; i < data.Length; i++)
         {
            ...
            else
            {
               ...
               if (!type.IsValueType)
                  ...
                  data[i] = Expression.Constant(Convert.ToSByte(item), typeof(sbyte)).Value;
               else
