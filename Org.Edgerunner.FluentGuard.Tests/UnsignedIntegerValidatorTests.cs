...
// <copyright file="UnsignedIntegerValidatorTests.cs" company="Edgerunner.org">
...
{
   /// <summary>
   ///    Class UnsignedIntegerValidatorTests.
   /// </summary>
   /// <seealso cref="uint" />
   ...
   public class UnsignedIntegerValidatorTests : ValidatorTests<uint>
   {
      /// <summary>
      ...
      [Example("foo", 4, 2)]
      [Example("foo", 1, 0)]
      public override void TestParameterGreaterThanPasses(string parameterName, uint parameterValue, uint valueToCompare, Validator<uint> validator)
      {
      ...
      [Example("foo", 0)]
      [Example("foo", 1)]
      public override void TestParameterIsFalseFails(string parameterName, uint parameterValue, Validator<uint> validator, Action act)
      {
      ...
      [Example("foo", 0)]
      [Example("foo", 1)]
      public override void TestParameterIsNegativeFails(string parameterName, uint parameterValue, Validator<uint> validator, Action act)
      {
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public override void TestParameterIsNotNegativePasses(string parameterName, uint parameterValue, Validator<uint> validator)
      {
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public override void TestParameterIsNotPositiveFails(string parameterName, uint parameterValue, Validator<uint> validator, Action act)
      {
      ...
      [Scenario]
      [Example("foo", 0)]
      public override void TestParameterIsNotPositivePasses(string parameterName, uint parameterValue, Validator<uint> validator)
      {
      ...
      [Scenario]
      [Example("foo", 0)]
      public override void TestParameterIsPositiveFails(string parameterName, uint parameterValue, Validator<uint> validator, Action act)
      {
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public override void TestParameterIsPositivePasses(string parameterName, uint parameterValue, Validator<uint> validator)
      {
      ...
      [Example("foo", 0)]
      [Example("foo", 1)]
      public override void TestParameterIsTrueFails(string parameterName, uint parameterValue, Validator<uint> validator, Action act)
      {
         "Given a new validator".x(() => validator = Ensure.That(parameterName, parameterValue));
      ...
      [Example("foo", 0)]
      [Example("foo", 1)]
      public override void TestParameterNotNullPasses(string parameterName, uint parameterValue, Validator<uint> validator)
      {
