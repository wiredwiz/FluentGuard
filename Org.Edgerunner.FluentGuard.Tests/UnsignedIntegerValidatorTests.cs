...
namespace Org.Edgerunner.FluentGuard.Tests
{
   ...
   public class UnsignedIntegerValidatorTests
   {
      ...
      /// <param name="validatorBase">The <see cref="UnsignedNumericValidator{Uint}" /> to test with.</param>     
      [Scenario]
      [Example("foo", 9, 2)]
      [Example("foo", 4, 2)]
      [Example("foo", 1, 0)]
      public void TestParameterGreaterThanPasses(string parameterName, uint parameterValue, uint valueToCompare, UnsignedNumericValidator<uint> validatorBase)
      {
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsNotPositiveFails(string parameterName, uint parameterValue, UnsignedNumericValidator<uint> validatorBase, Action act)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Scenario]
      [Example("foo", 0)]
      public void TestParameterIsNotPositivePasses(string parameterName, uint parameterValue, UnsignedNumericValidator<uint> validatorBase)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
