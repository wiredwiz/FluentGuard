...
namespace Org.Edgerunner.FluentGuard.Tests
{
   ...
   public class UnsignedIntegerValidatorTests
   {
      /// <summary>
      ...
      /// <param name="validator">The <see cref="UnsignedNumericValidator{Uint}" /> to test with.</param>     
      [Scenario]
      [Example("foo", 9, 2)]
      [Example("foo", 4, 2)]
      [Example("foo", 1, 0)]
      public void TestParameterGreaterThanPasses(string parameterName, uint parameterValue, uint valueToCompare, UnsignedNumericValidator<uint> validator)
      {
      ...
      public void TestParameterConditionAndFailsLower(
         ...
         uint lowerBound,
         uint upperBound,
         UnsignedNumericValidator<uint> validator,
         Action act)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsNotPositiveFails(string parameterName, uint parameterValue, UnsignedNumericValidator<uint> validator, Action act)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Scenario]
      [Example("foo", 0)]
      public void TestParameterIsNotPositivePasses(string parameterName, uint parameterValue, UnsignedNumericValidator<uint> validator)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Scenario]
      [Example("foo", 0)]
      public void TestParameterIsPositiveFails(string parameterName, uint parameterValue, UnsignedNumericValidator<uint> validator, Action act)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsPositivePasses(string parameterName, uint parameterValue, UnsignedNumericValidator<uint> validator)
      {
         "Given a new validator"
            .x(() => validator = Validate.That(parameterName, parameterValue));
