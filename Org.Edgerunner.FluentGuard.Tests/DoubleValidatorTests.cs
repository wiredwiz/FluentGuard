...
namespace Org.Edgerunner.FluentGuard.Tests
{
   ...
   public class DoubleValidatorTests
   {
      ...
      /// <param name="validatorBase">The <see cref="NumericValidator{Double}" /> to test with.</param>
      ...
      public void TestParameterConditionAndFailsLower(
         ...
         double lowerBound,
         double upperBound,
         NumericValidator<double> validatorBase,
         Action act)
      {
      ...
      public void TestParameterGreaterThanPasses(string parameterName, double parameterValue, double valueToCompare, NumericValidator<double> validatorBase)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 1.00001)]
      public void TestParameterIsNegativeFails(string parameterName, double parameterValue, NumericValidator<double> validatorBase, Action act)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", -1)]
      [Example("foo", -4)]
      public void TestParameterIsNegativePasses(string parameterName, double parameterValue, NumericValidator<double> validatorBase)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", -1)]
      [Example("foo", -4)]
      public void TestParameterIsNotNegativeFails(string parameterName, double parameterValue, NumericValidator<double> validatorBase, Action act)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsNotNegativePasses(string parameterName, double parameterValue, NumericValidator<double> validatorBase)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsNotPositiveFails(string parameterName, double parameterValue, NumericValidator<double> validatorBase, Action act)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", -1)]
      [Example("foo", -4)]
      public void TestParameterIsNotPositivePasses(string parameterName, double parameterValue, NumericValidator<double> validatorBase)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", -0.001)]
      [Example("foo", -1)]
      public void TestParameterIsPositiveFails(string parameterName, double parameterValue, NumericValidator<double> validatorBase, Action act)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
      ...
      [Example("foo", 1)]
      [Example("foo", 4)]
      public void TestParameterIsPositivePasses(string parameterName, double parameterValue, NumericValidator<double> validatorBase)
      {
         "Given a new ValidatorBase"
            .x(() => validatorBase = Validate.That(parameterName, parameterValue));
