...
// <copyright file="INullable.cs" company="Edgerunner.org">
...
{
   public interface INullableValidator<TV, TT> where TV : Validator<TT>
   {
      /// <summary>
      ...
      ValidatorLinkage<TV, TT> IsNotNull();
