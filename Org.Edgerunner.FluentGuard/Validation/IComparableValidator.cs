...
// <copyright file="IComparableValidator.cs" company="Edgerunner.org">
...
{
   public interface IComparableValidator<TV, TT> : IEquatableValidator<TV, TT> where TV : Validator<TT>
   {
      /// <summary>
      ...
      ValidatorLinkage<TV, TT> IsGreaterThan(TT value);
      ...
      ValidatorLinkage<TV, TT> IsGreaterThanOrEqualTo(TT value);
      ...
      ValidatorLinkage<TV, TT> IsLessThan(TT value);
      ...
      ValidatorLinkage<TV, TT> IsLessThanOrEqualTo(TT value);
   }
}