...
// <copyright file="IEquatable.cs" company="Edgerunner.org">
...
{
   public interface IEquatableValidator<TV, TT> where TV : Validator<TT>
   {
      /// <summary>
      ...
      ValidatorLinkage<TV, TT> IsEqualTo(bool value);
      ...
      ValidatorLinkage<TV, TT> IsNotEqualTo(bool value);
   }
}