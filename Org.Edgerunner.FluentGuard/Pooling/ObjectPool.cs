...
// Modified as public by Thaddeus Ryker for use in creating my own pooling classes outside of Roslyn
...
#endif
namespace Org.Edgerunner.FluentGuard.Pooling
{
   /// <summary>
   ...
   internal class ObjectPool<T> where T : class
   {
      ...
      /// <summary>
      /// Factory delegate used to create new instances of type T.
      /// </summary>
      ...
      /// </summary>
      /// <returns>A pooled instance of type T.</returns>
      ...
      /// </summary>
      /// <param name="obj">The object to free back into the pool.</param>
      /// <remarks>Search strategy is a simple linear probing which is chosen for it cache-friendliness.
      /// Note that Free will try to store recycled objects close to the start thus statistically
